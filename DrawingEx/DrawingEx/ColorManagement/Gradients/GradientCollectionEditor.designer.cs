...
namespace DrawingEx.ColorManagement.Gradients
{
	partial class GradientCollectionEditor
	{
		...
		private void InitializeComponent()
		{
			...
			this.edit = new DrawingEx.ColorManagement.Gradients.GradientEditPanel();
			...
			this.lstPresets.SelectionChanged += new ControlsEx.ListControls.SelectionChangeEventHandler(this.lstPresets_SelectionChanged);
			// 
			// ctxMenu
			// 
		...
		private GradientEditPanel edit;
