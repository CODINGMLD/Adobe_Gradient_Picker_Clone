namespace DrawingEx.ColorManagement.Gradients
{
	partial class GradientEditPanel
	{
		...
		private void InitializeComponent()
		{
			...
			this.lblColorSelect = new DrawingEx.ColorManagement.ColorLabel();
			this.edit = new DrawingEx.ColorManagement.Gradients.GradientEdit();
		...
		private DrawingEx.ColorManagement.ColorLabel lblColorSelect;
